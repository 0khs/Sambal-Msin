...
do
	...
	function library:toggle()
		...
		local container = self.container:WaitForChild("Main")
	...
	function section:addColorPicker(title, default, callback)
       ...
       input.InputChanged:Connect(function(input)
    if (draggingCanvas or draggingColor)
    and (input == currentInput) then
		...
		button.Activated:Connect(toggleTab)
		colorpicker.Activated:Connect(toggleTab)
	...
	slider.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 or 
		   input.UserInputType == Enum.UserInputType.Touch then
			...
			-- Handle drag ending
			dragConnection = game:GetService("UserInputService").InputEnded:Connect(function(endInput)
